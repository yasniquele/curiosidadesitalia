criaCartao(
  ...
  'O que significa o nome da Fontana di Trevi?',
  'O nome vem de Tre Vie, que significa três ruas, e a tradição é jogar uma moeda de costas para a fonte com a mão direita por cima do ombro esquerdo'
)

criaCartao(
  'Curiosidades sobre a Itália',
  'Como surgiu a massa na culinária italiana?',
  'A massa surgiu quando civilizações antigas, como os etruscos, esmagavam cereais, misturavam com água e cozinhavam, criando um alimento nutritivo'
)
